  ...
  return (
    <NativeTabs>
      ...
      <NativeTabs.Trigger name="settings">
        <Icon sf={{ default: 'gear', selected: 'gear.badge.checkmark' }} />
        <Label>Ajustes</Label>
      </NativeTabs.Trigger>
    </NativeTabs>
  );
    ...
    >
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) =>
            isIOS ? (
              <SymbolView name={focused ? 'stopwatch.fill' : 'stopwatch'} tintColor={color} size={24} />
            ) : (
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, focused }) =>
            isIOS ? (
              <SymbolView name={focused ? 'list.bullet.rectangle.fill' : 'list.bullet.rectangle'} tintColor={color} size={24} />
            ) : (
